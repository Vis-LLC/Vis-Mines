...
(function () {
    var Game = {
        ...
        Load: function () {
            Game.State.load("boards", "Games.Mines.LoadI");
        },
        ...
        StatIncrement: function (name, amount) {
            ...
            Game.State.load(name, "Games.Mines.StatIncrementI");
        },
        Init: function () {
            // TODO
            ...
            Game.Load();
            Game.State.load("theme", "Games.Mines.InitI");
        },
